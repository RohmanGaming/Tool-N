...
def ressture():
   ...
   import getpass
   sandi = raw_input('║PW      : ')
   if sandi == 'channel ROHMAN GAMING' and user == 'subscribe':
      print '║LOGIN SUKSES\n╚═══════\x1b[1;91m▶'
      sys.exit
   else:
...
def lodhirt():
    lodhirt = [
     'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING', '      ', 'ROHMAN GAMING\n']
    for o in lodhirt:
